 ...
 * 
 * This server runs the Hono app with PostgreSQL database support.
...
const env = {
  // Note: PostgreSQL connection is initialized globally via initDatabase()
  // The worker uses query() and execute() functions which access the pool directly
